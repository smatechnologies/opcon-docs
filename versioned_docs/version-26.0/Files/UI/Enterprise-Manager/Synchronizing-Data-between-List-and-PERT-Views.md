...
description: "Use this procedure to synchronize Data between List and PERT Views in the Enterprise Manager."
...
2.  Select on **PERT** under the **Operation** topic. The **PERT** screen displays
...
- A Data between List and PERT Views needs to be kept in sync with an external system

## Why Would You Use It?

- **Keep data consistent**: Synchronizing Data between List and PERT Views ensures OpCon reflects the current state of external systems, preventing stale data from causing errors
...
**Q: How many steps does the Synchronizing Data between List and PERT Views procedure involve?**

The Synchronizing Data between List and PERT Views procedure involves 9 steps. Complete all steps in order and save your changes.
