...
5. Change the frequency name to match the frequency name that has the same frequency definition
6. Select the **Finish** button
7. Clear the **Show duplicate frequency definitions only** option to show all frequency names
...
- **Showing Duplicate**: To show duplicate frequency definitions:
