...
- An existing Script Types in Enterprise Manager requires changes
- A change in process, system, or business requirement makes the current Script Types definition outdated

## Why Would You Use It?

- **Keep definitions current**: Updating Script Types in Enterprise Manager ensures changes apply to future builds without disrupting currently running schedules
- Changes to Script Types are recorded in the OpCon audit log, providing a complete modification history
