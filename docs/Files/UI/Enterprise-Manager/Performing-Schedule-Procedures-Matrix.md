...
Use the Matrix view in Enterprise Manager to perform schedule procedures such as placing schedules on hold, releasing held schedules, starting schedules, closing schedules, updating job statuses, editing schedules, checking schedules, deleting schedules, and adding jobs.
...
To place a schedule on hold, complete the following steps:
...
3. Right-click the **schedule** to place on hold and select **Hold**. The **HOLD** dialog displays.
4. *(Optional)* Enter a *short explanation for the status change* in the text box provided.
5. Select the **OK** button to confirm the schedule status change.

## Releasing Held Schedules

This action releases the selected schedule from a Held state. SAM processes jobs on the schedule from the point where they were stopped.

To release a held schedule, complete the following steps:

1. Select **Matrix** under the **Operation** topic. The **Matrix** screen displays.
2. Select the **number** for the day in the calendar that contains the schedule(s).
3. Right-click the **schedule** to release and select **Release**. The **Release** dialog displays.
4. *(Optional)* Enter a *short explanation for the status change* in the text box provided.
5. Select the **OK** button to confirm the schedule status change.

## Starting Schedules

This action overrides a schedule's start date and time. SAM begins processing as soon as this option is selected.

To start a schedule, complete the following steps:

1. Select **Matrix** under the **Operation** topic. The **Matrix** screen displays.
2. Select the **number** for the day in the calendar that contains the schedule(s).
3. Right-click the **schedule** to start and select **Start**. The **Start** dialog displays.
4. *(Optional)* Enter a *short explanation for the status change* in the text box provided.
5. Select the **OK** button to confirm the schedule status change.
...
To close a schedule, complete the following steps:

1. Select **Matrix** under the **Operation** topic. The **Matrix** screen displays.
2. Select the **number** for the day in the calendar that contains the schedule(s).
3. Right-click the **schedule** to close and select **Close**. The **Close** dialog displays.
4. *(Optional)* Enter a *short explanation for the status change* in the text box provided.
5. Select the **OK** button to confirm the schedule status change.

## Updating Job Statuses for Jobs on Schedules

To update job statuses for jobs on a schedule, complete the following steps:

1. Select **Matrix** under the **Operation** topic. The **Matrix** screen displays.
2. Select the **number** for the day in the calendar that contains the schedule(s).
3. Right-click the **schedule** to update and select **Update Job Statuses**. The **Update Job statuses** dialog displays.
4. Select the **job status** in the **Change all jobs statuses to** list.
5. *(Optional)* Select the **Check All** option to select all available job statuses in the **Jobs to update** frame.
6. Select the **job status** option(s) to update.
7. *(Optional)* Enter a *short explanation for the status change* in the text box provided.
8. Select the **OK** button to confirm the job status change.

## Editing Daily Schedules

This option allows you to edit the Daily schedule and make required changes.

To edit a daily schedule, complete the following steps:
...
To check a schedule, complete the following steps:
...
To add jobs to a schedule, complete the following steps:
...
5. Select the **Job** option(s) to add to the schedule, or select a job directly.
...
This page covers placing schedules on hold, releasing held schedules, starting schedules, closing schedules, updating job statuses, editing schedules, checking schedules, deleting schedules, and adding jobs.
