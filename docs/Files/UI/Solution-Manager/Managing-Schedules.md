...
Managing schedules includes Selection Options, Instance Definition Options, Build Options, Schedule Build Log. Access schedules in Solution Manager or Enterprise Manager.
