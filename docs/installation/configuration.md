...
To configure the database connection for the OpCon server, complete the following steps:
...
To create an Enterprise Manager database connection profile, complete the following steps:
...
To create a system DSN, complete the following steps:
...
To add the OpConxps Active Directory group to SQL Server, complete the following steps:
...
To add the SQL Server login for SMA Service Manager, complete the following steps:
...
To grant db_owner permissions for a Windows user, complete the following steps:
...
To configure the SMA LDAP Monitor, complete the following steps:
...
To configure SMASAPProxy, complete the following steps:
...
To create the machine, complete the following steps:
...
To create DSNs for the transport databases, complete the following steps:
...
To import the AdHoc schedule, complete the following steps:
...
To import the SMAReports schedule, complete the following steps:
...
To validate property definitions, complete the following steps:
...
To configure and start the SMA Service Manager, complete the following steps:
...
To request a license file, complete the following steps:
...
To place the license file, complete the following steps:
