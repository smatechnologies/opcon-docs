...
- A Job Procedures when Working in Matrix View action needs to be carried out in Enterprise Manager

## Why Would You Use It?

- **Ensure consistent operations**: Performing Job Procedures when Working in Matrix View actions through OpCon creates a centralized, auditable record of all operational changes
