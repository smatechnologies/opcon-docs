...
Container jobs have the ability to represent subschedules as nodes in the canvas. If a selected schedule is a subschedule itself (i.e., it has parent schedules), relevant subschedule and parent schedule information will be render in the bottom bar.
...
1. An list/array comprising all parent schedules that reference the currently selected schedule
