...
**Result:** The new department is saved and appears in the Departments list.
...
The **Name** field is required. Select **Save** on the toolbar to save the new record.

**Q: Is documentation required when adding departments?**

No. The Documentation field is optional. You can enter notes about the department to track its purpose, but it is not required to save the record.
