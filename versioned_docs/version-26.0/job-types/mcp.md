...
| Job Summary Information | For START type jobs, specifies a custom location for job summary information — useful for sites that store job summaries outside the MCP Agent default ... | location | Maximum 20 characters.  **Directory or File Name**: The dire |
