---
title: Instances Section Overview
description: "OpCon supports running the same schedule multiple times simultaneously using named instances or multi-instance definitions."
