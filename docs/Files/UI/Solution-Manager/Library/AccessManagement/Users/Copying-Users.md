...
- An existing Users definition needs to be duplicated in Solution Manager
- A new Users with similar settings to an existing one needs to be created quickly

## Why Would You Use It?

- **Save configuration time**: Duplicating an existing Users eliminates redundant data entry and ensures the new definition inherits proven settings
