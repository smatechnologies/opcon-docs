...
- An existing Thresholds definition needs to be duplicated in Enterprise Manager
- A new Thresholds with similar settings to an existing one needs to be created quickly

## Why Would You Use It?

- **Save configuration time**: Duplicating an existing Thresholds eliminates redundant data entry and ensures the new definition inherits proven settings
