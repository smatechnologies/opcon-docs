...
- A Schedule Status Changes action needs to be carried out in Solution Manager

## Why Would You Use It?

- **Ensure consistent operations**: Performing Schedule Status Changes actions through OpCon creates a centralized, auditable record of all operational changes
