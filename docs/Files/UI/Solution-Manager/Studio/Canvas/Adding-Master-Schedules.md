...
To add a schedule name and documentation, complete the following steps:

1. Enter a **Schedule Name**. For more information, refer to [Schedules](../../../../../objects/schedules.md) in the **Concepts** online help.
...
To configure holiday calendar settings, complete the following steps:
...
:::note
All autobuild settings reset and become disabled when the **Sub Schedule** option is selected.
:::

To configure schedule build settings, complete the following steps:
...
1. Enter the number of **Days in Advance**.
1. Enter the number of **Days to build for**.
...
**Q: How do you save a new master schedule record?**

After completing the required fields, select the **Save** button on the toolbar to save the master schedule record.

**Q: What happens to autobuild settings when Sub Schedule is selected?**
