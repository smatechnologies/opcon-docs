---
title: Accessing the Solution
description: "OpCon Solution Manager is a web-based interface for managing OpCon from any supported browser. Connecting to it requires meeting minimum system requirements, authenticating with valid credentials, and understanding the navigation layout — including keyboard shortcuts for efficient use."
...
- A supported web browser (see System Requirements)
- A valid OpCon user account with an assigned role
- Network access to the OpCon server
...
**Q: Who manages Solution Manager in OpCon?**

All users interact with Solution Manager. Administrators configure settings, manage user access, and monitor related processes.
