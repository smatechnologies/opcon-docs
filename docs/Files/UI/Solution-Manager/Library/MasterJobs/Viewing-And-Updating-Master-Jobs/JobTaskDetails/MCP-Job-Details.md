...
MCP job details define how OpCon submits a job to a Burroughs MCP system, including user code, access code, file title, and task attributes. These details are configured in the Task Details panel of an MCP master job in Solution Manager or the Enterprise Manager.
