...
- An existing Schedule Instance Properties in Enterprise Manager is no longer needed
- The Schedule Instance Properties has been decommissioned or replaced and should be removed to keep the configuration clean

## Why Would You Use It?

- **Maintain a clean environment**: Removing unused Schedule Instance Properties definitions reduces clutter and prevents accidental use of outdated or obsolete configurations
