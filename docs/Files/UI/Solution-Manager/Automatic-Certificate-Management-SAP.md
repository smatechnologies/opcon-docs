...
Use the shared **Agent Configuration view** and **troubleshooting steps** in the main guide — they apply to the SAP Agent without any platform-specific differences.
