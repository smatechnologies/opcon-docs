...
:white_check_mark: **OC-5889**: Message deletion logic has been corrected to use true message ID boundaries, preventing accidental deletion of unread or newly inserted messages.
...
:white_check_mark: **OC-4754**: Fixed an issue in MCP jobs where negative numbers in arguments were not allowed.
