...
To use a user-defined calendar as an additional holiday calendar, complete the following steps:
...
**Result:** The user-defined calendar is applied as an additional holiday calendar for the schedule.

## Using as Annual Plan Calendars

To use a user-defined calendar as an annual plan calendar, complete the following steps:
...
**Result:** The frequency is created using the selected calendar as an annual plan.

## Using as Negative Annual Plan Calendars

To use a user-defined calendar as a negative annual plan calendar, complete the following steps:
...
**Result:** The frequency is created using the selected calendar as a negative annual plan.

## FAQs

**Q: What can you do with User-defined Calendars?**

User-defined Calendars can be used as additional holiday calendars, annual plan calendars, and negative annual plan calendars.
