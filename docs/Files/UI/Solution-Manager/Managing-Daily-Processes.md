...
Managing daily processes includes Toolbar Options, Date/Schedule Selection Enabling/Disabling, Filter Profiles, Filtering. Access daily processes in Solution Manager.
