...
description: "Use this procedure to define Properties for Single Instance Jobs in the Enterprise Manager."
...
- A new Properties for Single Instance Jobs definition needs to be established in Enterprise Manager

## Why Would You Use It?

- **Establish reusable definitions**: Defining Properties for Single Instance Jobs in OpCon creates a reusable reference that schedules, jobs, and events can share
