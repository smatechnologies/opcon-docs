---
title: Agents Admin Overview
description: "The Agents administration section lets you monitor all registered agents, start and stop communication, and perform bulk status updates."
...
| Automatic Certificate Management: SAP BW Agent | What differs on the SAP BW Agent for automatic certificate provisioning and renewal |
