...
To create a script type, complete the following steps:

1. Select the **New Script Type** button above the list.
...
To check cross references for a script type, complete the following steps:
...
Managing script types includes adding, editing, and deleting records. Access script types in Solution Manager under **Library** > **Scripts** > **Script Types**.
