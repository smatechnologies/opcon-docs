...
Managing notification settings includes Required Privileges, Configuring Notification. Access notification settings in Solution Manager or Enterprise Manager.
