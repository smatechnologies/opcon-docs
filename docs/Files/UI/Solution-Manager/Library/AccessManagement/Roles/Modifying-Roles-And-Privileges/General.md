...
**Q: Where can I find the Role General tab in OpCon?**

Go to **Library > Access Management > Roles** in Solution Manager, select a role, and select the **General** tab.

**Q: What can I change on the General tab?**

You can update the role name and description. After making changes, select **Save** to apply them.
