...
2.  Select on **Gantt** under the **Operation** topic. The **Gantt** screen displays
3.  Select and drag the **Gantt** tab to the right side of the screen
4.  When the mouse changes to an **arrow symbol** pointing right, release the **Gantt** tab
5.  Select to activate the ![Listen for Selection icon](../../../Resources/Images/EM/EMlistenforchanges.png "Listen for Selection icon") **Listen for selection changes in other views** button on the **Gantt** toolbar
...
8.  View the schedule and related job information in the **Gantt** view
9.  Select to deactivate the **Listen for selection changes in other views** button on the **Gantt** toolbar
:::
...
- A Data between List and Gantt Views needs to be kept in sync with an external system

## Why Would You Use It?

- **Keep data consistent**: Synchronizing Data between List and Gantt Views ensures OpCon reflects the current state of external systems, preventing stale data from causing errors
