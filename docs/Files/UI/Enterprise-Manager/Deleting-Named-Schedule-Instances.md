...
- An existing Named Schedule Instances in Enterprise Manager is no longer needed
- The Named Schedule Instances has been decommissioned or replaced and should be removed to keep the configuration clean

## Why Would You Use It?

- **Maintain a clean environment**: Removing unused Named Schedule Instances definitions reduces clutter and prevents accidental use of outdated or obsolete configurations
