---
title: EM Getting Started Overview
description: "Before using Enterprise Manager for the first time, configure a connection profile for your OpCon server, set your preferences, and optionally change the language."
