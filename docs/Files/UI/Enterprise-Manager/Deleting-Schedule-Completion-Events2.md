...
**Q: How do you delete a schedule completion event from the daily tables?**

Select the event in the **Events** frame, select **Remove**, then confirm the deletion when prompted.
